...
A semantic element clearly describes its meaning to both the browser and the developer. For example <table> or <form> lets both know exactly what the item is.
...
vertical axis or cross axis

5. Explain why git is valuable to a team of developers.
It always code to be saved to prevent data loss. It also allows multiple team members to work on a view all the code in one project. 
